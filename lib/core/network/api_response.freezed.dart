...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T? data, int statusCode, String? errorCode, String? message});
}
...
class _$ApiResponseImpl<T> extends _ApiResponse<T> {
  const _$ApiResponseImpl(
      {this.data, required this.statusCode, this.errorCode, this.message})
      : super._();
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(data: $data, statusCode: $statusCode, errorCode: $errorCode, message: $message)';
  }
